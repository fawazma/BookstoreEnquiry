...
## Instructions:
1- create a file in your computer named "Bookstore". 
2- clone the repo to that directory.
3- Open a terminal,
### Compile:
```
...
## Program features:
- Displaying the existed books.
- User can rate the books.
- Searching by letters and words.
